/*     http://www.mrobot.by
    ...
    Спасибо за эту программу моему китайскому другу 하늘.
    Вот ссылка на его github репозиторий https://github.com/allskyee/v4l2_mjpeg_streamer
    И если ты прочел это сообщение, значит ты любишь досконально разобраться в программе.
    Высылаю мое личное приглашение к нам в команду по робототехнике MaxxlifeRobot
    Пиши мне vk.com/maxxlife или maxxlife@mail.ru
    */
#include <stdio.h>
#include <time.h>
#include <signal.h>
